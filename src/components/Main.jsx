        ...
        <div id="parent">
            <div id="mainContainer">
                <div id="carousel">
                    ...
                    <ImageCarousel.Item>
                        <img src={require('../assets/prop1.webp')} alt='prop 1'  />
                    </ImageCarousel.Item>
                    <ImageCarousel.Item>
                ...
                <div id="new">
                    ...
                    <Listing cart={false} name={'VARTA akumuliatorius 1'} image={require('../assets/prop1.webp')} price={'10.99'} code={'ASD123'}  alt={'Prop 1'}/>
                ...
                <div id="new">
                    ...
                    <Carousel responsive={responsive}>
                        <ListingAlternate cart={false} name={'VARTA akumuliatorius 1'} image={require('../assets/prop1.webp')} price={'10.99'} code={'ASD123'}  alt={'Prop 1'}/>
            ...
            <div id="popular">
                <h2>Perkamiausi</h2>
                <Carousel responsive={responsive}>
                    <ListingAlternate name={'VARTA akumuliatorius 1'} image={require('../assets/prop1.webp')} price={'10.99'} code={'ASD123'} alt={'Prop 1'}/>
